...
export const checkoutSchema = yup.object({
    ...
    phone: yup.string().trim().matches(/^(0|\+84)\d{9,10}$/, "Invalid phone number").required("Phone is required"),
    ...
    deliveryDate: yup.string().required("Delivery date is required").test("future-date", "Delivery date must be from tomorrow", (value)=>{
